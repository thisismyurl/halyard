 ...
 */
?>
<!-- wp:group {"tagName":"footer","className":"halyard-inverted-footer","style":{"spacing":{"padding":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|8","left":"var:preset|spacing|5","right":"var:preset|spacing|5"}},"color":{"background":"var:preset|color|base-black","text":"var:preset|color|base-paper"}},"layout":{"type":"constrained","contentSize":"1200px"}} -->
<footer class="wp-block-group halyard-inverted-footer has-base-paper-color has-base-black-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<h2 class="wp-block-heading has-serif-font-family" style="margin-bottom:var(--wp--preset--spacing--3);font-size:var(--wp--preset--font-size--lg);font-weight:400"><?php echo esc_html__( 'Site Name', 'halyard' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|sm","lineHeight":"1.6"},"color":{"text":"var:preset|color|base-rule"}}} -->
			<p class="has-base-rule-color has-text-color" style="font-size:var(--wp--preset--font-size--sm);line-height:1.6"><?php echo esc_html__( 'A short tagline that says what this site is about in a single, plain sentence.', 'halyard' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<h3 class="wp-block-heading has-base-rule-color has-text-color has-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--4);font-size:var(--wp--preset--font-size--xs);font-weight:600;letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( 'Explore', 'halyard' ); ?></h3>
			<!-- /wp:heading -->
			...
			<li><a href="#"><?php echo esc_html__( 'Home', 'halyard' ); ?></a></li>
			<!-- /wp:list-item -->

			<!-- wp:list-item -->
			<li><a href="#"><?php echo esc_html__( 'Articles', 'halyard' ); ?></a></li>
			<!-- /wp:list-item -->

			<!-- wp:list-item -->
			<li><a href="#"><?php echo esc_html__( 'About', 'halyard' ); ?></a></li>
			<!-- /wp:list-item -->

			<!-- wp:list-item -->
			<li><a href="#"><?php echo esc_html__( 'Archive', 'halyard' ); ?></a></li>
			<!-- /wp:list-item --></ul>
			<!-- /wp:list -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|xs","fontWeight":"600","letterSpacing":"0.08em","textTransform":"uppercase"},"spacing":{"margin":{"bottom":"var:preset|spacing|4"}},"color":{"text":"var:preset|color|base-rule"}},"fontFamily":"sans"} -->
			<h3 class="wp-block-heading has-base-rule-color has-text-color has-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--4);font-size:var(--wp--preset--font-size--xs);font-weight:600;letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( 'Contact', 'halyard' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|sm","lineHeight":"1.8"},"color":{"text":"var:preset|color|base-rule"}}} -->
			<p class="has-base-rule-color has-text-color" style="font-size:var(--wp--preset--font-size--sm);line-height:1.8">hello@example.com<br><?php echo esc_html__( '123 Example Street', 'halyard' ); ?><br><?php echo esc_html__( 'City, Region', 'halyard' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	...
	<p class="has-base-rule-color has-text-color has-sans-font-family" style="font-size:var(--wp--preset--font-size--xs)"><?php
		...
		printf(
			...
			esc_html__( '© %1$s %2$s. All rights reserved.', 'halyard' ),
			esc_html( gmdate( 'Y' ) ),
			esc_html__( 'Site Name', 'halyard' )
		);
	?></p>
	<!-- /wp:paragraph -->
