...
<p class="has-base-mid-color has-text-color" style="font-size:var(--wp--preset--font-size--sm)"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html__( 'Home', 'halyard' ); ?></a></p>
<!-- /wp:paragraph -->
