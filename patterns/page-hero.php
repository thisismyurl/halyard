...
<section class="wp-block-group has-base-paper-background-color has-background" style="padding-top:var(--wp--preset--spacing--12);padding-bottom:var(--wp--preset--spacing--12);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
	...
	<h2 class="wp-block-heading has-serif-font-family" style="margin-bottom:var(--wp--preset--spacing--6);font-size:var(--wp--preset--font-size--display);line-height:1.05;letter-spacing:-0.02em"><?php echo esc_html__( 'A clean foundation for editorial work', 'halyard' ); ?></h2>
	<!-- /wp:heading -->
	...
	<p class="has-base-mid-color has-text-color has-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--8);font-size:var(--wp--preset--font-size--lg);line-height:1.5"><?php echo esc_html__( 'A minimal, accessible starter theme built for typography, structure, and the words that matter most.', 'halyard' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button has-custom-font-size has-sans-font-family" style="font-size:var(--wp--preset--font-size--sm)"><a class="wp-block-button__link has-base-paper-color has-base-accent-background-color has-text-color has-background wp-element-button" style="border-radius:0px;padding-top:var(--wp--preset--spacing--4);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--4);padding-left:var(--wp--preset--spacing--6)"><?php echo esc_html__( 'Get started', 'halyard' ); ?></a></div>
		<!-- /wp:button -->
		...
		<div class="wp-block-button is-style-outline has-custom-font-size has-sans-font-family" style="font-size:var(--wp--preset--font-size--sm)"><a class="wp-block-button__link has-base-ink-color has-text-color wp-element-button" style="border-color:var(--wp--preset--color--base-rule);border-width:1px;border-radius:0px;padding-top:var(--wp--preset--spacing--4);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--4);padding-left:var(--wp--preset--spacing--6)"><?php echo esc_html__( 'Read the docs', 'halyard' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
