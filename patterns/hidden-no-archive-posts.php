 ...
 * Slug: halyard/hidden-no-archive-posts
 * Categories: colophon
 * Inserter: false
 * Description: Not for the pattern picker — a translation-string carrier only.
 *
 * templates/archive.html's query-no-results references this purely so the
...
<p class="has-base-mid-color has-text-color" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10)"><?php echo esc_html__( 'No posts found in this archive.', 'halyard' ); ?></p>
<!-- /wp:paragraph -->
